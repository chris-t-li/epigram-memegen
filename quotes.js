// Alan Perlis EPIGRAMS IN PROGRAMMING. Reference: http://www.cs.yale.edu/homes/perlis-alan/quotes.html 

const str = `1. One man's constant is another man's variable.
...
for(i = 1; i<=120; i++) {
    arrayquotes.push(str.substring(str.search(`${i}.`), str.search(`${i+1}.`)-2));
}

function randomquote() {
    const randomInt = Math.floor(120*Math.random());
    return arrayquotes[randomInt]
}
